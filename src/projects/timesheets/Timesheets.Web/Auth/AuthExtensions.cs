...
namespace Timesheets.Web.Auth
{
    ...
    {
        public static void AddAuth<TSettings>(this IServiceCollection services, TSettings settings) where TSettings : WebSiteSettings
        {
            services.AddDbContext<AuthDbContext>(options =>
            {
                options.UseSqlServer(settings.ConnectionStrings.AuthSql);
            });
