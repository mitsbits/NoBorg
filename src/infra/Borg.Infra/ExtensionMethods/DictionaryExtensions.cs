...
namespace Borg
{
    public static class DictionaryExtensions
    {
        ...
        public static void AppendAndUpdate<TKey, TValue>(this IDictionary<TKey, TValue> home,
        ...
        private static void Merge<TKey, TValue>(this IDictionary<TKey, TValue> home, IDictionary<TKey, TValue> data,
            MergeOperation operation = MergeOperation.AppendAndUpdate)
        {
